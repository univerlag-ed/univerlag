...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <xsl:variable name="home-collection">handle/3/Regular_publications</xsl:variable>
    <xsl:variable name="special-collection">handle/3/Publcations_in_cooperation</xsl:variable>
    <xsl:variable name="series-collection">handle/3/Series</xsl:variable>
    <xsl:variable name="ring-lectures">info/list</xsl:variable>
