        ...
        <div class="row view-more">
            <p>
                ...
                <a>
                    ...
                    <xsl:attribute name="href"><xsl:value-of select="concat(substring-before(./dri:xref/@target, 'recent-submissions'), 'browse?sort_by=3&amp;order=DESC&amp;type=dateissued')" /></xsl:attribute>
